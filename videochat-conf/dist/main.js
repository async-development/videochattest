...
const uniqueRandomArray = __webpack_require__(33);
const femaleDogNames = __webpack_require__(35);
const maleDogNames = __webpack_require__(36);
...
const uniqueRandom = __webpack_require__(34);
...
var isCordovaEnv = !!window.cordova;
var GUEST_ROOM_ONLY_MODE = false;
var CALLING_ONLY_MODE = isCordovaEnv;
var NO_ASNWER_TIMER = 30000; // 30 sec

var GET_USERS_STATS_TIME_INTERVAL = 3000;
var MAX_MIC_LEVEL = 20000;
var CLEANING_SLOW_LINK_INTERVAL = 10; //sec

var defaultAvatarlist = ['animals_1.jpg', 'animals_2.jpg', 'animals_3.jpg', 'animals_4.jpg', 'animals_5.jpg', 'animals_6.jpg', 'animals_7.jpg', 'animals_8.jpg', 'animals_9.jpg', 'animals_10.jpg'];
// CONCATENATED MODULE: ./src/auth-service.js
...
var auth_service_AuthService = /*#__PURE__*/function () {
  function AuthService() {
    ...
    _defineProperty(this, "$loginScreen", document.getElementById("login"));

    _defineProperty(this, "$callScreen", document.getElementById("call"));

    _defineProperty(this, "$loader", document.getElementById("login-loader"));

    _defineProperty(this, "$caption", document.getElementById("login-caption"));

    _defineProperty(this, "init", function () {
      var janusServerEndpoint = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    ...
    _defineProperty(this, "login", function (user) {
      return new Promise(function (resolve, reject) {
        _this.$loader.classList.remove("hidden");

        _this.$caption.classList.add("hidden");

        _this.createSession(user).then(function () {
          ...
          _this.$callScreen.classList.remove("hidden");
    ...
    _defineProperty(this, "hideLoginScreen", function () {
      _this.$loginScreen.classList.add("hidden");
    });
    ...
    _defineProperty(this, "logout", function () {
      ...
      _this.$callScreen.classList.add("hidden");

      _this.$loginScreen.classList.remove("hidden");
    });
  }
...
var Auth = new auth_service_AuthService(); // lock instance

Object.freeze(Auth);
/* harmony default export */ var auth_service = (Auth);
...
var detectBrowser = function detectBrowser() {
  ...
  if (sUsrAg.indexOf("Firefox") > -1) {
    ...
    sBrowser = "SamsungInternet"; // "Mozilla/5.0 (Linux; Android 9; SAMSUNG SM-G955F Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/9.4 Chrome/67.0.3396.87 Mobile Safari/537.36
    ...
    sBrowser = "InternetExplorer"; // "Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; .NET4.0C; .NET4.0E; Zoom 3.6.0; wbx 1.0.0; rv:11.0) like Gecko"
  } else if (sUsrAg.indexOf("Edge") > -1) {
    sBrowser = "Edge"; // "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36 Edge/16.16299"
  } else if (sUsrAg.indexOf("Chrome") > -1) {
    sBrowser = "Chrome"; //Chrome or Chromium
    // "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/66.0.3359.181 Chrome/66.0.3359.181 Safari/537.36"
  } else if (sUsrAg.indexOf("Safari") > -1) {
    sBrowser = "Safari"; // "Mozilla/5.0 (iPhone; CPU iPhone OS 11_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/11.0 Mobile/15E148 Safari/604.1 980x1306"
  } else {
    sBrowser = "unknown";
  }
...
// CONCATENATED MODULE: ./src/call-service.js
var _window$device;
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { call_service_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function call_service_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function call_service_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function call_service_createClass(Constructor, protoProps, staticProps) { if (protoProps) call_service_defineProperties(Constructor.prototype, protoProps); if (staticProps) call_service_defineProperties(Constructor, staticProps); return Constructor; }

function call_service_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }




var isiOS = ((_window$device = window.device) === null || _window$device === void 0 ? void 0 : _window$device.platform) === "iOS" || !!navigator.platform && /iPad|iPhone|iPod/.test(navigator.platform);
;
...
var isWebRTCSupported = window.RTCPeerConnection !== undefined && window.RTCPeerConnection !== null && navigator.getUserMedia !== undefined && navigator.getUserMedia !== null;

var call_service_CallService = /*#__PURE__*/function () {
  function CallService() {
    var _this = this;

    call_service_classCallCheck(this, CallService);

    call_service_defineProperty(this, "_answerUserTimers", {});

    call_service_defineProperty(this, "currentUserID", void 0);

    call_service_defineProperty(this, "participantIds", []);

    call_service_defineProperty(this, "initiatorID", void 0);

    call_service_defineProperty(this, "janusRoomId", void 0);

    call_service_defineProperty(this, "isGuestMode", void 0);

    call_service_defineProperty(this, "currentUserName", void 0);

    call_service_defineProperty(this, "avatarIndex", {});

    call_service_defineProperty(this, "usersStatsList", {});

    call_service_defineProperty(this, "updateStatsTimer", null);

    call_service_defineProperty(this, "conectedParticipantIds", []);

    call_service_defineProperty(this, "isSharingScreen", false);

    call_service_defineProperty(this, "startEventSharinScreen", null);

    call_service_defineProperty(this, "init", function () {
      ConnectyCube.chat.onSystemMessageListener = _this.onSystemMessage.bind(_this);
      ConnectyCube.videochatconference.onParticipantJoinedListener = _this.onAcceptCallListener.bind(_this);
      ConnectyCube.videochatconference.onParticipantLeftListener = _this.onStopCallListener.bind(_this);
      ConnectyCube.videochatconference.onRemoteStreamListener = _this.onRemoteStreamListener.bind(_this);
      ConnectyCube.videochatconference.onSlowLinkListener = _this.onSlowLinkListener.bind(_this);
      ConnectyCube.videochatconference.onRemoteConnectionStateChangedListener = _this.onRemoteConnectionStateChangedListener.bind(_this);
      ConnectyCube.videochatconference.onSessionConnectionStateChangedListener = _this.onSessionConnectionStateChangedListener.bind(_this);
      document.getElementById("call-modal-reject").addEventListener("click", function () {
        return _this.rejectCall();
      });
      document.getElementById("call-modal-accept").addEventListener("click", function () {
        return _this.acceptCall();
      });
      document.body.classList.add('black-bg');
      CallService.ACTIVE_BROWSER = detectBrowser();
    });

    call_service_defineProperty(this, "sendIncomingCallSystemMessage", function (participantIds) {
      var msg = {
        extension: {
          callStart: '1',
          janusRoomId: _this.janusRoomId,
          participantIds: participantIds.join(',')
        }
      };
      return participantIds.map(function (user_id) {
        return ConnectyCube.chat.sendSystemMessage(user_id, msg);
      });
    });

    call_service_defineProperty(this, "sendRejectCallMessage", function (participantIds, janusRoomId, isBusy) {
      var msg = {
        extension: {
          callRejected: '1',
    ...
    call_service_defineProperty(this, "sendEndCallMessage", function (participantIds, janusRoomId) {
      var msg = {
        extension: {
          callEnd: '1',
          janusRoomId: janusRoomId
    ...
    call_service_defineProperty(this, "$calling", document.getElementById("signal-in"));

    call_service_defineProperty(this, "$dialing", document.getElementById("signal-out"));

    call_service_defineProperty(this, "$endCall", document.getElementById("signal-end"));

    call_service_defineProperty(this, "$modal", document.getElementById("call-modal-icoming"));

    call_service_defineProperty(this, "$muteUnmuteAudioButton", document.getElementById("videochat-mute-unmute"));

    call_service_defineProperty(this, "$muteUnmuteVideoButton", document.getElementById("videochat-mute-unmute-video"));

    call_service_defineProperty(this, "$switchCameraButton", document.getElementById("videochat-switch-camera"));

    call_service_defineProperty(this, "$switchSharingScreenButton", document.getElementById("videochat-sharing-screen"));

    call_service_defineProperty(this, "mediaParams", {
      video: {
        width: 1280,
        height: 720
      },
    ...
    call_service_defineProperty(this, "sharingScreenMediaParams", {
      audio: true,
      video: {
        frameRate: {
          ideal: 10,
    ...
    call_service_defineProperty(this, "_session", null);

    call_service_defineProperty(this, "videoDevices", []);

    call_service_defineProperty(this, "defaultSettings", function () {
      if (isMobile) {
        _this.$switchSharingScreenButton.disabled = true;
      }
    });

    call_service_defineProperty(this, "addStreamElement", function (opponents) {
      var $videochatStreams = document.getElementById("videochat-streams");
      var $videochatStreamsTemplate = document.getElementById("videochat-streams-template");

      if (!Array.isArray(opponents)) {
        opponents = [opponents];
      }

      var curretActiveCallUsersCout = _this._getActiveCallUsers().length;

      var documentFragment = document.createDocumentFragment();
      opponents.forEach(function (opponent, index) {
        var videochatStreamsTemplate = handlebars_default.a.compile($videochatStreamsTemplate.innerHTML);
        ...
        streamBlock.dataset.id = "".concat(opponent.id);
        streamBlock.style.gridArea = "stream".concat(index + curretActiveCallUsersCout);
        documentFragment.appendChild(streamBlock);
      });
      $videochatStreams.classList.value = "grid-".concat(opponents.length + curretActiveCallUsersCout);
      $videochatStreams.appendChild(documentFragment);

      _this.initStatsTooltip();
    });

    call_service_defineProperty(this, "startMonitoringUserStats", function (userId) {
      if (!userId) {
        return;
      }

      clearInterval(_this.updateStatsTimer);

      _this.conectedParticipantIds.push(userId);

      _this.updateStatsTimer = setInterval(function () {
        _this.conectedParticipantIds.forEach(function (user_id) {
          _this.getUserStat(user_id);
        });
      }, GET_USERS_STATS_TIME_INTERVAL);
    });

    call_service_defineProperty(this, "stopMonitoringUserStats", function (userId) {
      if (userId) {
        var updateConectedParticipantIds = [];

        _this.conectedParticipantIds.forEach(function (element) {
          element !== userId && updateConectedParticipantIds.push(element);
        });

        _this.conectedParticipantIds = updateConectedParticipantIds;
      } else {
        clearInterval(_this.updateStatsTimer);
      }
    });

    call_service_defineProperty(this, "goodSlowLinkIconColor", function (userId) {
      var $selectedUserStat = document.querySelector(".display-signal-icon[data-id=\"".concat(userId, "\"]"));
      $selectedUserStat.classList.remove('average');
    });

    call_service_defineProperty(this, "averageSlowLinkIconColor", function (userId) {
      var $selectedUserStat = document.querySelector(".display-signal-icon[data-id=\"".concat(userId, "\"]"));
      $selectedUserStat.classList.add('average');
    });

    call_service_defineProperty(this, "checkTimeStampSlowLink", function (user_id, stat) {
      if (Date.now() / 1000 - _this.usersStatsList[user_id].timeStampSlowLink < CLEANING_SLOW_LINK_INTERVAL) {
        stat.connection = 'average';
        stat.timeStampSlowLink = _this.usersStatsList[user_id].timeStampSlowLink;
      } else {
        stat.connection = 'good';
        stat.timeStampSlowLink = null;

        _this.goodSlowLinkIconColor(user_id);
      }

      return stat;
    });

    call_service_defineProperty(this, "getUserStat", function (user_id) {
      if (_this.currentUserID !== user_id) {
        var _this$usersStatsList$;

        var stat = {
          micLevel: _this._session.getRemoteUserVolume(user_id),
          bitrate: _this._session.getRemoteUserBitrate(user_id),
          connection: 'good'
        };

        if ((_this$usersStatsList$ = _this.usersStatsList[user_id]) === null || _this$usersStatsList$ === void 0 ? void 0 : _this$usersStatsList$.timeStampSlowLink) {
          stat = _this.checkTimeStampSlowLink(user_id, stat);
        }

        if (CallService.ACTIVE_BROWSER === 'Safari') {
          var newBitrate = stat.bitrate.split(' ')[0] / 1000;
          stat.bitrate = "".concat(Math.round(newBitrate), " kbits/sec");
        }

        _this.usersStatsList[user_id] = stat;
      } else {
        var _this$usersStatsList$2;

        var _stat = {
          connection: 'good'
        };

        if ((_this$usersStatsList$2 = _this.usersStatsList[user_id]) === null || _this$usersStatsList$2 === void 0 ? void 0 : _this$usersStatsList$2.timeStampSlowLink) {
          _stat = _this.checkTimeStampSlowLink(user_id, _stat);
        }

        _this.usersStatsList[user_id] = _stat;
      }
    });

    call_service_defineProperty(this, "initStatsTooltip", function () {
      $(".tooltip-container").tooltipster({
        ...
        functionInit: function functionInit(instance, helper) {
          _this.initToolTispterUI(instance, helper);
        },
        functionBefore: function functionBefore(instance) {
          var user_id = window.ConnectyCubeActiveUserStatId;

          if (_this.currentUserID !== user_id && !_this.usersStatsList[user_id].bitrate) {
            instance.content("<ul>\n              <li>Connection: N/A</li>\n              <li>Bitrate: N/A</li>\n              <li>Mic level: N/A</li>\n            </ul>");
          }

          if (_this.currentUserID !== user_id) {
            var volume = _this.usersStatsList[user_id].micLevel / MAX_MIC_LEVEL * 100;
            instance.content("<ul>\n              <li>Connection: ".concat(_this.usersStatsList[user_id].connection, "</li>\n              <li>Bitrate: ").concat(_this.usersStatsList[user_id].bitrate, "</li>\n              <li>Mic level: ").concat(volume.toFixed(2), "%</li>\n            </ul>"));
          } else {
            instance.content("<ul>\n              <li>Connection: ".concat(_this.usersStatsList[user_id].connection, "</li>\n            </ul>"));
          }
        }
    ...
    call_service_defineProperty(this, "setDefaultAvatar", function (user_id) {
      var $avatar = document.querySelector(".user-placeholder[data-id=\"".concat(user_id, "\"] .user-image"));

      if (!_this.avatarIndex[user_id]) {
        _this.avatarIndex[user_id] = Math.floor(Math.random() * 10);
      }

      $avatar.style.background = "#ffffff url(\"../images/animals/".concat(defaultAvatarlist[_this.avatarIndex[user_id]], "\") no-repeat center");
      $avatar.style.backgroundSize = 'contain';
    });

    call_service_defineProperty(this, "onSystemMessage", function (msg) {
      console.warn('[onSystemMessage]', msg);
      var extension = msg.extension,
          userId = msg.userId;

      if (extension.callStart) {
        var participantIds = extension.participantIds,
            janusRoomId = extension.janusRoomId;
        var oponentIds = participantIds.split(',').map(function (user_id) {
          return +user_id;
        }).filter(function (user_id) {
          return user_id != _this.currentUserID;
        });

        if (_this.janusRoomId) {
          return _this.sendRejectCallMessage([].concat(_toConsumableArray(oponentIds), [userId]), janusRoomId, true);
        }

        _this.janusRoomId = janusRoomId;
        _this.initiatorID = userId;
        _this.participantIds = oponentIds;

        _this.showIncomingCallModal();
      } else if (extension.callRejected) {
        var _janusRoomId = extension.janusRoomId;

        if (_this.janusRoomId === _janusRoomId) {
          var busy = extension.busy;

          _this.onRejectCallListener(_this._session, userId, {
            busy: busy
          });
        }
      } else if (extension.callEnd) {
        var _janusRoomId2 = extension.janusRoomId;

        if (_this.janusRoomId === _janusRoomId2) {
          _this.onStopCallListener(_this._session, userId);
        }
      }
    });

    call_service_defineProperty(this, "onAcceptCallListener", function (session, userId, displayName) {
      console.warn('[onAcceptCallListener]', userId, displayName);
      var userName = _this.isGuestMode ? displayName : _this._getUserById(userId, "name");
      var infoText = "".concat(userName, " has ").concat(_this.isGuestMode ? 'joined' : 'accepted', " the call");

      _this.showSnackbar(infoText);

      _this.startMonitoringUserStats(userId);

      if (_this.isGuestMode) {
        var userToAdd = {
          id: +userId,
          name: "".concat(displayName || userId)
        };

        _this.addStreamElement(userToAdd);
      ...
      _this.clearNoAnswerTimers(userId);
    });

    call_service_defineProperty(this, "onRejectCallListener", function (session, userId) {
      var extension = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

      var userName = _this._getUserById(userId, "name");

      var infoText = extension.busy ? "".concat(userName, " is busy") : "".concat(userName, " rejected the call request");

      _this.stopCall(userId);

      _this.showSnackbar(infoText);
    });

    call_service_defineProperty(this, "onStopCallListener", function (session, userId) {
      console.warn('[onStopCallListener]', userId);
      var isStoppedByInitiator = _this.initiatorID === userId;
      var userName = _this.initGuestRoom ? userId : _this._getUserById(userId, "name");
      var infoText = "".concat(userName, " has ").concat(isStoppedByInitiator ? "stopped" : "left", " the call");

      _this.showSnackbar(infoText);

      if (isStoppedByInitiator) {
        if (_this.$modal.classList.contains("show")) {
          _this.hideIncomingCallModal();
        }
    ...
    call_service_defineProperty(this, "onUserNotAnswerListener", function (session, userId) {
      ...
      var infoText = "".concat(userName, " did not answer");

      _this.showSnackbar(infoText);

      _this.sendEndCallMessage([userId], _this.janusRoomId);

      _this.stopCall(userId);
    });

    call_service_defineProperty(this, "onRemoteStreamListener", function (session, userId, stream) {
      ...
      _this._session.attachMediaStream(_this.getStreamIdByUserId(userId), stream);

      _this.removeStreamLoaderByUserId(userId);

      var isStremaWithVideo = stream.getVideoTracks().length > 0;

      _this._prepareVideoElement(userId, isStremaWithVideo);
    });

    call_service_defineProperty(this, "onSlowLinkListener", function (session, userId, uplink, nacks) {
      ...
      var merge = _objectSpread({}, _this.usersStatsList[userId], {}, stat);

      _this.usersStatsList[userId] = merge;

      _this.averageSlowLinkIconColor(userId);
    });

    call_service_defineProperty(this, "onRemoteConnectionStateChangedListener", function (session, userId, iceState) {
      console.warn('[onRemoteConnectionStateChangedListener]', userId, iceState);
    });

    call_service_defineProperty(this, "onSessionConnectionStateChangedListener", function (session, iceState) {
      console.warn('[onSessionConnectionStateChangedListener]', iceState);

      if (iceState === 'connected') {
        _this.startMonitoringUserStats(_this.currentUserID);
      }
    });

    call_service_defineProperty(this, "acceptCall", function () {
      var opponentsIds = [_this.initiatorID].concat(_toConsumableArray(_this.participantIds));
      var opponents = opponentsIds.map(function (id) {
        return {
          id: id,
          name: _this._getUserById(id, "name")
        };
      });

      _this.addStreamElement(opponents);

      _this.hideIncomingCallModal();

      _this.startNoAnswerTimers(_this.participantIds);

      _this.joinConf(_this.janusRoomId);

      _this.startMonitoringUserStats(_this.currentUserID);
    });

    call_service_defineProperty(this, "rejectCall", function (session) {
      var extension = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var participantIds = [_this.initiatorID].concat(_toConsumableArray(_this.participantIds));

      _this.sendRejectCallMessage(participantIds, _this.janusRoomId, false);
    ...
    call_service_defineProperty(this, "startCall", function () {
      var opponents = [];
      var opponentsIds = [];
      document.querySelectorAll(".select-user-checkbox").forEach(function ($checkbox) {
        if ($checkbox.checked) {
          ...
          var name = _this._getUserById(id, "name");
      ...
      if (opponents.length > 0) {
        _this.participantIds = opponentsIds;
        _this.janusRoomId = _this._getUniqueRoomId();

        _this.sendIncomingCallSystemMessage(opponentsIds, _this.janusRoomId);
        ...
        _this.initiatorID = _this.currentUserID;

        _this.startNoAnswerTimers(_this.participantIds);

        _this.joinConf(_this.janusRoomId);
      } else {
        _this.showSnackbar(messages.select_more_users);
      }

      _this.startMonitoringUserStats(_this.initiatorID);
    });

    call_service_defineProperty(this, "_renderListCameraBlock", function () {
      $(".tooltip-container-list-camera").tooltipster({
        ...
        functionBefore: function functionBefore(instance) {
          var htmlBlock = '';
          _this.listenersCameraList;

          _this.videoDevices.forEach(function (elem) {
            if (_this._session.activeVideoDeviceId !== elem.id) {
              htmlBlock = htmlBlock + "<button id=\"".concat(elem.id, "\" class=\"switch-camera-item\" value=\"").concat(elem.id, "\">").concat(elem.name, "</button>");
            } else {
              htmlBlock = htmlBlock + "<button id=\"".concat(elem.id, "\" class=\"switch-camera-item\" value=\"").concat(elem.id, "\" disabled>").concat(elem.name, "</button>");
            }
          });

          instance.content("<div class=\"switch-camera-block\">\n            ".concat(htmlBlock, "\n          </div>\n          "));
        },
        functionReady: function functionReady() {
          _this.videoDevices.forEach(function (elem) {
            document.getElementById("".concat(elem.id)).addEventListener("click", function (htmlProperty) {
              return _this.switchCamera(htmlProperty);
            });
          });
        }
      });
    ...
    call_service_defineProperty(this, "initToolTispterUI", function (instance, helper) {
      ...
      if (data) {
        data = (_readOnlyError("data"), JSON.parse(data));
    ...
    call_service_defineProperty(this, "switchCamera", function (event) {
      event.stopPropagation();

      _this._session.switchMediaTracks({
        video: event.toElement.value
      }).then(function (newLocalStream) {
        _this.toggelStreamMirror(_this.currentUserID);

        if (isMobile) {
          _this._session.attachMediaStream(_this.getStreamIdByUserId(_this.currentUserID), newLocalStream, {
            muted: true
          });
        }
      });
    ...
    call_service_defineProperty(this, "joinConf", function (janusRoomId, retry) {
      _this._session = ConnectyCube.videochatconference.createNewSession();

      _this.defaultSettings();

      if (!_this._session.getDisplayMedia) {
        _this.$switchSharingScreenButton.disabled = true;
      }

      return _this._session.getUserMedia(_this.mediaParams).then(function (stream) {
        _this.addStreamElement({
          id: _this.currentUserID,
          name: 'Me',
          local: true
        });

        _this.removeStreamLoaderByUserId(_this.currentUserID);

        _this._session.attachMediaStream(_this.getStreamIdByUserId(_this.currentUserID), stream, {
          muted: true
        });

        _this._prepareVideoElement(_this.currentUserID, _this.mediaParams.video);

        _this.toggelStreamMirror(_this.currentUserID);

        return _this._session.join(janusRoomId, _this.currentUserID, _this.currentUserName).then(function () {
          return _this.postJoinActions();
        });
      }, function (error) {
        console.warn('[Get user media error]', error, _this.mediaParam);

        if (!retry) {
          _this.mediaParams.video = false;
          return _this.joinConf(janusRoomId, true);
        }
      });
    });

    call_service_defineProperty(this, "stopCall", function (userId) {
      var $callScreen = document.getElementById("call");
      var $videochatScreen = document.getElementById("videochat");
      var $muteButton = document.getElementById("videochat-mute-unmute");
      var $videochatStreams = document.getElementById("videochat-streams");

      if (userId) {
        _this.clearNoAnswerTimers(userId);

        _this.participantIds = _this.participantIds.filter(function (participant_id) {
          return participant_id != userId;
        });

        _this.removeStreamBlockByUserId(userId);

        _this.stopMonitoringUserStats(userId);

        var $streams = Array.from(document.querySelectorAll(".videochat-stream-container"));

        if ($streams.length < 2 && !_this.isGuestMode) {
          _this.stopCall();
        } else {
          _this.updateStreamGridOnRemove($streams, $videochatStreams);
        }
      } else {
        if (!_this.isGuestMode) {
          _this.sendEndCallMessage([].concat(_toConsumableArray(_this.participantIds), [_this.initiatorID]), _this.janusRoomId);
        }

        if (_this._session) {
          _this._session.leave();
        }

        ConnectyCube.videochatconference.clearSession(_this._session.id);
        ...
        _this.$muteUnmuteAudioButton.disabled = true;
        _this.$muteUnmuteVideoButton.disabled = true;
        _this.$switchCameraButton.disabled = true;
        _this._session = null;
        _this.videoDevices = [];

        _this.clearNoAnswerTimers();

        _this.initiatorID = void 0;
        _this.participantIds = [];
        _this.janusRoomId = void 0;
        _this.currentUserName = void 0; // this.mediaParams = {video: true, audio: true}
        ...
        _this.usersStatsList = {};
        _this.conectedParticipantIds = [];

        _this.stopMonitoringUserStats();

        _this.startEventSharinScreen = null;

        if (_this.isSharingScreen) {
          _this.isSharingScreen = false;

          _this.updateSharingScreenBtn();
        }
    ...
    call_service_defineProperty(this, "addBodyOnClickListener", function () {
      document.body.onclick = _this.onClickBody;
    });

    call_service_defineProperty(this, "onClickBody", function () {
      var callToolButtons = document.getElementById('videochat-buttons-container');
      callToolButtons.classList.toggle('hidden');
    });

    call_service_defineProperty(this, "setAudioMute", function () {
      var $muteAudioButton = document.getElementById("videochat-mute-unmute");

      if (_this._session.isAudioMuted()) {
        _this._session.unmuteAudio();

        $muteAudioButton.classList.remove("muted");
      } else {
        _this._session.muteAudio();

        $muteAudioButton.classList.add("muted");
      }
    });

    call_service_defineProperty(this, "setVideoMute", function () {
      var $muteVideoButton = document.getElementById("videochat-mute-unmute-video");

      if (_this._session.isVideoMuted()) {
        _this._session.unmuteVideo();

        $muteVideoButton.classList.remove("muted");

        _this.toggleUserPlaceholder(_this.currentUserID, false);
      } else {
        _this._session.muteVideo();

        $muteVideoButton.classList.add("muted");

        _this.toggleUserPlaceholder(_this.currentUserID, true);
      }
    });

    call_service_defineProperty(this, "sharingScreen", function () {
      if (!_this.isSharingScreen) {
        return _this._session.getDisplayMedia(_this.sharingScreenMediaParams, true).then(function (stream) {
          ...
          _this.$muteUnmuteVideoButton.disabled = true;
          _this.startEventSharinScreen = stream.getVideoTracks()[0].addEventListener('ended', function () {
            return _this.stopSharingScreen();
          });
        }, function (error) {
          console.warn('[Get display media error]', error, _this.mediaParam);

          _this.stopSharingScreen();
        });
      } else {
        _this.stopSharingScreen();
      }
    ...
    call_service_defineProperty(this, "stopSharingScreen", function () {
      return _this._session.getUserMedia(_this.mediaParams, true).then(function (stream) {
        _this.updateStream(stream);

        _this.$muteUnmuteVideoButton.disabled = false;
        _this.isSharingScreen = false;
    ...
    call_service_defineProperty(this, "updateStream", function (stream) {
      _this._session.attachMediaStream(_this.getStreamIdByUserId(_this.currentUserID), stream, {
        muted: true
      });
      ...
      _this.postJoinActions();
    });

    call_service_defineProperty(this, "updateSharingScreenBtn", function () {
      var $videochatSharingScreen = document.getElementById('videochat-sharing-screen');
      var $videochatSharingScreenIcon = document.getElementById('videochat-sharing-screen-icon');
    ...
    call_service_defineProperty(this, "showSnackbar", function (infoText) {
    ...
    call_service_defineProperty(this, "showIncomingCallModal", function () {
      return _this._incomingCallModal("show");
    });

    call_service_defineProperty(this, "hideIncomingCallModal", function () {
      return _this._incomingCallModal("hide");
    });

    call_service_defineProperty(this, "_incomingCallModal", function (className) {
      var $initiator = document.getElementById("call-modal-initiator");
      ...
      if (className === "hide") {
        ...
        $initiator.innerHTML = _this._getUserById(_this.initiatorID, "name");
    ...
    call_service_defineProperty(this, "_getUserById", function (userId, key) {
    ...
    call_service_defineProperty(this, "_prepareVideoElement", function (user_id, isStremaWithVideo) {
      if (!isStremaWithVideo) {
        return _this.toggleUserPlaceholder(user_id, true);
      }

      var $video = document.getElementById(_this.getStreamIdByUserId(user_id));
    ...
    call_service_defineProperty(this, "initGuestRoom", function (janusRoomId) {
      _this.currentUserID = _this._getUniqueUserId();
      var parseName = JSON.parse(localStorage.getItem(CallService.USER_NAME_KEY));
      var userName = parseName ? parseName : _this.getRandomName();

      while (!_this.currentUserName) {
        _this.currentUserName = prompt(messages.prompt_user_name, userName);
        localStorage.setItem(CallService.USER_NAME_KEY, JSON.stringify(_this.currentUserName));

        if (_this.currentUserName === null) {
      ...
      _this.isGuestMode = true;

      if (janusRoomId) {
        _this.janusRoomId = janusRoomId;
      } else {
        _this.janusRoomId = _this._getUniqueRoomId();
        var roomInfo = btoa("".concat(_this.janusRoomId, "##").concat(appConfig.conference.server));
        window.history.replaceState({}, 'Conference Guest Room', "/join/".concat(roomInfo));
      }

      _this.joinConf(_this.janusRoomId).then(function () {
        return _this.showSnackbar(messages.share_call_link);
      });
    });

    call_service_defineProperty(this, "getRandomName", function () {
      var dogNames = __webpack_require__(32);

      return dogNames.allRandom();
    });
  }

  call_service_createClass(CallService, [{
    key: "toggleUserPlaceholder",
    value: function toggleUserPlaceholder(user_id, toShow) {
      var $userPlaceHolder = document.querySelector(".user-placeholder[data-id=\"".concat(user_id, "\"]"));
    ...
    key: "_getActiveCallUsers",
    value: function _getActiveCallUsers() {
      var $streamsContainers = document.querySelectorAll(".videochat-stream-container");
      var stream = Array.from($streamsContainers);
      return stream.map(function (_ref) {
        var dataset = _ref.dataset;
        return {
          id: +dataset.id,
          name: "".concat(dataset.id)
        };
      });
    }
  }, {
    key: "_getUniqueRoomId",
    value: function _getUniqueRoomId() {
      return ConnectyCube.chat.helpers.getBsonObjectId();
    }
  }, {
    key: "_getUniqueUserId",
    value: function _getUniqueUserId() {
      var randomValue = "".concat(Math.random()).replace('0.', '');
      return parseInt(randomValue.slice(0, 3) + randomValue.slice(-3), 10);
    }
  }, {
    key: "setSwitchDevice",
    value: function setSwitchDevice() {
      var _this2 = this;

      ConnectyCube.videochatconference.getMediaDevices(ConnectyCube.videochatconference.DEVICE_INPUT_TYPES.VIDEO).then(function (devices) {
        _this2.$switchCameraButton.disabled = _this2.videoDevices.length < 1;
        devices.forEach(function (elem) {
          _this2.videoDevices.push({
            id: elem.deviceId,
            name: elem.label
          });
        });
        _this2.$switchCameraButton.disabled = false;

        _this2._renderListCameraBlock();
      });
    }
  }, {
    key: "toggelStreamMirror",
    value: function toggelStreamMirror(user_id) {
      var $stream = document.getElementById(this.getStreamIdByUserId(user_id));
      $stream.classList.toggle('mirror');
    }
  }, {
    key: "updateStreamGridOnRemove",
    value: function updateStreamGridOnRemove($streams, $videochatStreams) {
      $streams.forEach(function ($stream, index) {
        return $stream.style.gridArea = "stream".concat(index);
      });
      $videochatStreams.classList.value = "grid-".concat($streams.length);
    }
  }, {
    key: "postJoinActions",
    value: function postJoinActions() {
    ...
    key: "getStreamIdByUserId",
    value: function getStreamIdByUserId(userId) {
      return "stream-".concat(userId);
    }
  }, {
    key: "removeStreamLoaderByUserId",
    value: function removeStreamLoaderByUserId(user_id) {
      var $loader = document.querySelector(".videochat-stream-loader[data-id=\"".concat(user_id, "\"]"));
    ...
    key: "removeStreamBlockByUserId",
    value: function removeStreamBlockByUserId(user_id) {
      var $streamBblock = document.querySelector(".videochat-stream-container[data-id=\"".concat(user_id, "\"]"));
      $streamBblock.remove();
    }
  }, {
    key: "startNoAnswerTimers",
    value: function startNoAnswerTimers(participantIds) {
      var _this3 = this;

      participantIds.forEach(function (user_id) {
        _this3._answerUserTimers[user_id] = setTimeout(function () {
          return _this3.onUserNotAnswerListener(_this3._session, user_id);
        }, NO_ASNWER_TIMER);
      });
    }
  }, {
    key: "clearNoAnswerTimers",
    value: function clearNoAnswerTimers(user_id) {
      if (user_id) {
        clearTimeout(this._answerUserTimers[user_id]);
        return delete this._answerUserTimers[user_id];
      }

      Object.values(this._answerUserTimers).forEach(function (timerId) {
...
call_service_defineProperty(call_service_CallService, "USER_NAME_KEY", "ConnectyCubeVideoConf:UserNameKey");

call_service_defineProperty(call_service_CallService, "ACTIVE_BROWSER", null);

/* harmony default export */ var call_service = (new call_service_CallService());
// CONCATENATED MODULE: ./src/ui-service.js
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || ui_service_unsupportedIterableToArray(arr, i) || _nonIterableRest(); }

function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function ui_service_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return ui_service_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(n); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ui_service_arrayLikeToArray(o, minLen); }

function ui_service_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function _iterableToArrayLimit(arr, i) { if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return; var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }

function ui_service_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function ui_service_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var ui_service_UIService = function UIService() {
  var _this = this;

  ui_service_classCallCheck(this, UIService);

  ui_service_defineProperty(this, "init", function () {
    ...
    var res = _this.parseJoinRoomUrl();
    ...
    if (res) {
      ...
      var _res = _slicedToArray(res, 2),
          janusRoomId = _res[0],
          janusServerEndpoint = _res[1];

      auth_service.init(janusServerEndpoint);

      _this.createAndJoinGuestRoom(janusRoomId);
    ...
    _this.renderLoginUsers();

    document.querySelectorAll(".login-button[data-id]").forEach(function ($element) {
      return $element.addEventListener("click", _this.login);
    });
    document.getElementById('guest-room-join-btn').addEventListener('click', function () {
      return _this.createAndJoinGuestRoom();
    });
  });

  ui_service_defineProperty(this, "addEventListenersForCallButtons", function () {
    document.getElementById("call-start").addEventListener("click", _this.buttonOnClickListener(function () {
      return call_service.startCall();
    }));
    document.getElementById("videochat-stop-call").addEventListener("click", _this.buttonOnClickListener(function () {
      return call_service.stopCall();
    }));
    document.getElementById("videochat-mute-unmute").addEventListener("click", _this.buttonOnClickListener(function () {
      return call_service.setAudioMute();
    }));
    document.getElementById("videochat-mute-unmute-video").addEventListener("click", _this.buttonOnClickListener(function () {
      return call_service.setVideoMute();
    }));
    document.getElementById("videochat-switch-camera").addEventListener("click", _this.buttonOnClickListener(function () {}));
    document.getElementById("videochat-sharing-screen").addEventListener("click", _this.buttonOnClickListener(function () {
      return call_service.sharingScreen();
    }));
  });

  ui_service_defineProperty(this, "buttonOnClickListener", function (callback) {
  ...
  ui_service_defineProperty(this, "parseJoinRoomUrl", function () {
    var pathname = window.location.pathname;

    var _pathname$split = pathname.split('/'),
        _pathname$split2 = _slicedToArray(_pathname$split, 3),
        joinPath = _pathname$split2[1],
        roomInfo = _pathname$split2[2];
  ...
  ui_service_defineProperty(this, "createAndJoinGuestRoom", function (janusRoomId) {
    auth_service.createSession().then(function () {
      call_service.init();
      auth_service.hideLoginScreen();
      call_service.initGuestRoom(janusRoomId);

      _this.addEventListenersForCallButtons();
    });
  });

  ui_service_defineProperty(this, "login", function (_ref) {
    var target = _ref.target;
    var currentUserId = +target.dataset.id;
    var currentUser = users.find(function (_ref2) {
      var id = _ref2.id;
      return currentUserId === id;
    });
    auth_service.login(currentUser).then(function () {
      call_service.init();
      call_service.currentUserName = currentUser.name;
      call_service.currentUserID = +currentUserId;

      _this.renderSelectUsers(currentUserId);

      _this.addEventListenersForCallButtons();
    });
  });

  ui_service_defineProperty(this, "renderLoginUsers", function () {
    var $loginButtonsContainer = document.getElementById("login-buttons-container");
    var $loginButtonsTemplate = document.getElementById("login-buttons-template");
    var loginButtonsTemplate = handlebars_default.a.compile($loginButtonsTemplate.innerHTML);
    $loginButtonsContainer.innerHTML = loginButtonsTemplate({
      users: users,
      drawUsers: !GUEST_ROOM_ONLY_MODE,
  ...
  ui_service_defineProperty(this, "renderSelectUsers", function (currentUserId) {
    var $callSelectUsers = document.getElementById("call-select-users");
    var $selectUsersTemplate = document.getElementById("select-users-template");
    var selectUsersTemplate = handlebars_default.a.compile($selectUsersTemplate.innerHTML);
    var usersForSelect = users.filter(function (_ref3) {
      var id = _ref3.id;
      return currentUserId !== id;
    });
    $callSelectUsers.innerHTML = selectUsersTemplate({
...
var UI = new ui_service_UIService(); // lock instance

Object.freeze(UI);
/* harmony default export */ var ui_service = (UI);
